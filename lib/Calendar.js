...
var Calendar = _react2.default.createClass({
  ...
  getViews: function getViews() {
    ...
    if (Array.isArray(views)) {
      return (0, _object.transform)(views, function (obj, name) {
        return obj[name] = _Views2.default[name];
      }, {});
    }

    if ((typeof views === 'undefined' ? 'undefined' : _typeof(views)) === 'object') {
      return (0, _object.mapValues)(views, function (value, key) {
        if (value === true) {
  ...
  render: function render() {
    ...
    var viewComponents = (0, _object.defaults)(components[view] || {}, (0, _object.omit)(components, names));
